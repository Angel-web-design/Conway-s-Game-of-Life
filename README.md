...
- [ ]  Add a zoom in and zoom out functionality for the editor scene.
...
> [!IMPORTANT]
> **The project requires the `JDK 24` to function**


> [!NOTE]
> **The project uses `Gradle` v.8.14 (It's included inside the `build.gradle` and doesn't need to be installed manually)**
> 
> **The project uses the `JavaFX SDK` v25.0.1 (It's included inside the `build.gradle` and doesn't need to be installed manually)**
...
<div align="center">Created by Miguel Angel Ortiz Loaiza</div>
